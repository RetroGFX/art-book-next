...
| -- | -- | -- |
| Distribution | Used to define which folder to look in for Theme Customization files. | `Batocera/Knulli`, `UnofficialOS`, `RetroBat` |
...
- This value determines the folder where you will add your customizations
    ...
    - UnofficialOS = `/roms/_userdata/theme-customizations/art-book-next/`
